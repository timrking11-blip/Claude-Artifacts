...
# The model provider (Claude on Vertex by default, or Gemini) is chosen in
# account_research/model.py. It is deliberately NOT imported here: the ledger
# tools and their tests must import this package without ADK or the Anthropic
# SDK installed, and the same code must run unchanged inside Agent Runtime.
