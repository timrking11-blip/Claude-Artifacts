...
leadership changes visible on the page. If the page is empty, a login wall, an
error page, or otherwise uninformative, say exactly that in one sentence. Do not
